...
func Embed(file, packageName string, dirs ...string) error {
...
func (fs *fs) ModTime() time.Time{ return modifyTime }
...
func (f *file) ModTime() time.Time{ return modifyTime }
func (f *file) IsDir() bool { return false }
func (f *file) Sys() interface{} { return nil }

func init() {
`, packageName, time.Now().Unix())
